...
if __name__ == "__main__":
    ...
    files="eeee_158002_raw_hist.root"
    ...
    TITLES = {"l_e":["E [GeV]","events / 20GeV "],
              ...
              "delta_R_zz":["#{Delta}R_zz", "events/ "],
              "delta_R_jj":["#{Delta}R_jj", "events/ "],
              "delta_R_zz_jj":["#{Delta}R_zzjj", "events/ "],
              "delta_R_ll_1-delta_R_ll_2":["#{Delta}R_ll", "events/ "],
    ...
    for entry in VAR_4:
        for par in entry[0]:
            for var in entry[1]:
                ...
                legends = [ par+"1", par+"2", par+"3", par+"4" ]
